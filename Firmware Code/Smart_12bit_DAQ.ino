...
// ....................................................................................
  ...
  if ( (dataverse->config.UPLOAD_DATASET_DELTA_TIME < ( millis() -  dataverse->LAST_DATASET_UPLOAD )) ){
    dataverse->LAST_DATASET_UPLOAD= millis();

    interface->onBoardLED->led[1] = interface->onBoardLED->LED_BLUE;
    interface->onBoardLED->statusLED(100, 0.04);
    ...
    xSemaphoreTake(interface->McuFreqSemaphore, portMAX_DELAY); 
      interface->McuFrequencyBusy=true;
      changeMcuFreq(interface, interface->WIFI_FREQUENCY);
      mserial->printStrln("setting to WIFI EN CPU Freq = " +String(getCpuFrequencyMhz()));
      interface->McuFrequencyBusy=false;
    xSemaphoreGive(interface->McuFreqSemaphore); 
